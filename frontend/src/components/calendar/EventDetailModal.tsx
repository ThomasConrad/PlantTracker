          ...
          <div class="p-6">
            <div class="flex items-start space-x-4">
              ...
              <div class="flex-1">
                ...
                <Show
                  when={
                    deriveEntryType(props.entry) === "measurement" &&
                    props.entry.measurements?.length
                  }
                >
                  <div class="mb-4">
                    <h4 class="text-sm font-medium text-gray-700 mb-2">
                ...
                <Show
                  when={
                    props.entry.photoIds &&
                    Array.isArray(props.entry.photoIds) &&
                    props.entry.photoIds.length > 0
                  }
                >
                  <div class="mb-4">
                    <h4 class="text-sm font-medium text-gray-700 mb-2">
                      Photos ({(props.entry.photoIds as string[]).length})
                    </h4>
