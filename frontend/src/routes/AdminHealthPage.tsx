            ...
            <div class="px-4 py-5 sm:p-6">
              <div class="flex items-center justify-between">
                ...
                <div class="text-right">
                  <span
                    class={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ${getStatusBadge(health()?.status || "unknown")}`}
                  >
            ...
            <div class="px-4 py-5 sm:p-6">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div class="text-center p-4 bg-gray-50 rounded-lg">
                  <div
                    class={`text-2xl font-bold ${getStatusColor(health()?.database.status || "unknown")}`}
                  >
            ...
            <div class="px-4 py-5 sm:p-6">
              ...
              <div class="space-y-4">
                <div class="flex justify-between items-center p-3 bg-gray-50 rounded">
                  ...
                  <span
                    class={`text-sm ${getStatusColor(health()?.status || "unknown")}`}
                  >
                    {health()?.status || "Unknown"}
                  </span>
                </div>
                ...
                <div class="flex justify-between items-center p-3 bg-gray-50 rounded">
                  ...
                  <span class="text-sm text-gray-600">
                    {health()?.uptime.note || "Not implemented"}
                  </span>
                </div>
              </div>
            </div>
              ...
              <div class="ml-3">
                ...
                <div class="mt-2 text-sm text-yellow-700">
                  <ul class="list-disc pl-5 space-y-1">
                    <li>
                      Monitor database size regularly and consider maintenance
                      if it grows too large
                    </li>
                    <li>
                      High activity might indicate the need for performance
                      optimization
                    </li>
                    <li>
                      Check system resources if database operations become slow
                    </li>
