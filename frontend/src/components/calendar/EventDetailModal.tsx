            ...
            <div class="flex items-start space-x-4">
              ...
              <div class="flex-1">
                ...
                <Show when={props.entry.photoIds && Array.isArray(props.entry.photoIds) && props.entry.photoIds.length > 0}>
                  <div class="mb-4">
                    <h4 class="text-sm font-medium text-gray-700 mb-2">Photos</h4>
                    <p class="text-sm text-gray-600 bg-blue-50 p-3 rounded-md flex items-center">
                      ...
                      {(props.entry.photoIds as string[]).length} photo(s) attached
                    </p>
                  </div>
                </Show>
              </div>
