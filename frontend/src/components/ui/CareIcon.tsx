    ...
    watering: (
      <>
        <path
          ...
          d="M12 3v17.25l-4.5-4.5L12 16l4.5 4.5V3"
        />
        <path
          stroke-linecap="round"
          stroke-linejoin="round"
    ...
    pruning: (
      <>
        <path
          stroke-linecap="round"
          stroke-linejoin="round"
          d="M6.75 7.5l3 3M6.75 7.5l-1.5-1.5M6.75 7.5h7.5M17.25 16.5l-3-3M17.25 16.5l1.5 1.5M17.25 16.5H9.75"
        />
    ...
    repotting: (
      <>
        <path
          stroke-linecap="round"
          stroke-linejoin="round"
          d="M20.25 7.5l-.625 10.632a2.25 2.25 0 01-2.247 2.118H6.622a2.25 2.25 0 01-2.247-2.118L3.75 7.5M10 11.25h4M10 11.25c0 .621-.504 1.125-1.125 1.125H8.25m1.875-1.125l-.875-.875M14 11.25c0 .621.504 1.125 1.125 1.125H15.75m-1.875-1.125l.875-.875"
        />
        <path
          stroke-linecap="round"
          stroke-linejoin="round"
...
export const FertilizingIcon: Component<Omit<CareIconProps, "type">> = (
  props,
...
export const RepottingIcon: Component<Omit<CareIconProps, "type">> = (
  props,
) => <CareIcon type="repotting" {...props} />;

export const PestControlIcon: Component<Omit<CareIconProps, "type">> = (
  props,
