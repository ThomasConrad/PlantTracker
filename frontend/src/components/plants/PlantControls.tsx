    ...
    <div class="space-y-4 px-4 sm:px-0">
      ...
      <div class="flex flex-col sm:flex-row gap-4">
        ...
        <div class="hidden sm:block relative">
          ...
          <svg
            class="absolute right-2 top-1/2 transform -translate-y-1/2 h-4 w-4 text-gray-500 pointer-events-none"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
      ...
      <div
        class={`sm:hidden overflow-hidden transition-all duration-200 ${isFiltersOpen() ? "max-h-40" : "max-h-0"}`}
      >
