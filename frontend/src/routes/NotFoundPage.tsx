        ...
        <div>
          <div class="mx-auto h-24 w-24 rounded-full bg-green-100 dark:bg-green-900/40 flex items-center justify-center">
            ...
            >
              ...
              />
              <path
                d="M32 20C32 14 38 11 43 12C43 18 38 23 32 23"
                fill="#68D391"
              />
              <path
                d="M32 20C32 14 26 11 21 12C21 18 26 23 32 23"
                fill="#48BB78"
              />
              ...
              <path
                d="M28 45C29.2 46.6 30.8 47.4 32 47.4C33.2 47.4 34.8 46.6 36 45"
                stroke="#2D3748"
                stroke-width="1.8"
                stroke-linecap="round"
              />
