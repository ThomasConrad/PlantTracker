        ...
        <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-8">
          ...
          <div class="prose prose-gray dark:prose-invert max-w-none">
            ...
            <section class="mb-8">
              ...
              <p class="mb-4">
                Planty collects minimal information necessary to provide our
                plant tracking service:
              </p>
              <ul class="list-disc pl-6 mb-4">
                <li>Account information: Email address, name, and password</li>
                <li>
                  Plant data: Plant names, care schedules, photos, and tracking
                  entries you create
                </li>
                <li>
                  Usage data: Basic analytics about how you use the application
                </li>
              </ul>
            </section>
            ...
            <section class="mb-8">
              ...
              <p class="mb-4">
                ...
                information to third parties. Your plant data remains private
                and is only accessible to you through your account.
              </p>
            </section>
            ...
            <section class="mb-8">
              ...
              <p class="mb-4">
                ...
                is active or as needed to provide you services. You may delete
            ...
            <section class="mb-8">
              ...
              <p class="mb-4">
                ...
                provide basic functionality. No tracking or advertising cookies
                are used.
              </p>
            </section>
