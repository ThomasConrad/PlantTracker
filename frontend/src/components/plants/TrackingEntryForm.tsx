...
export const TrackingEntryForm: Component<TrackingEntryFormProps> = (props) => {
  ...
  const handleSubmit = async (e: Event) => {
    ...
    if (mode() === 'measurement' && selectedMetricId() && customValue()) {
      ...
      if (metric) {
        ...
        data.measurements = [{ metricId: selectedMetricId(), value: parsedValue }];
      }
    }
  ...
  const isSubmitDisabled = () => {
    ...
    if (mode() === 'measurement' && (!selectedMetricId() || !customValue())) return true;
      ...
      >
        ...
        <form onSubmit={handleSubmit} class="modal-body">
          <div class="space-y-6">
            ...
            <Show when={mode() === 'care'}>
              <div class="space-y-4">
                <h3 class="text-sm font-medium text-gray-900">Select Care Tasks</h3>
