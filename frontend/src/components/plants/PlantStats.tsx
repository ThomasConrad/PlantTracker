...
export const PlantStats: Component<PlantStatsProps> = (props) => {
  const careTasks = () =>
    (props.plant.careTasks ?? []).filter(
      (t) => t.intervalDays != null && !t.archivedAt,
    );
  ...
  return (
    <div class="card">
      ...
      <div class="card-body">
        <Show
          when={careTasks().length > 0}
          fallback={
            <div class="text-center py-4">
              <p class="text-sm text-gray-500 italic">
                No scheduled care tasks
              </p>
            </div>
          }
        >
                ...
                <div class={`p-4 rounded-lg ${getStatusColor(task)}`}>
                  <div class="flex items-center">
                    ...
                    <div class="ml-3">
                      ...
                      <p class="text-sm font-semibold">{getStatusText(task)}</p>
