        ...
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="mt-2 text-gray-600">
              Configure global system settings and limitations
            </p>
          </div>
          <A
              ...
              <div class="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    value={maxUsers()}
                    onInput={(e) =>
                      setMaxUsers(parseInt(e.currentTarget.value) || 0)
                    }
                    min="1"
                    max="100000"
                  ...
                  <p class="mt-1 text-sm text-gray-500">
                    Maximum number of user accounts that can be created in the
                    system.
                  </p>
                </div>
                ...
                <div>
                  ...
                  />
                  <p class="mt-1 text-sm text-gray-500">
                    Default number of invites new users can create. Set to 0 to
                    disable invite creation for regular users.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p class="mt-1 text-sm text-gray-500">
                    Allow new users to register with valid invite codes. If
                    disabled, only existing admins can create accounts.
                  </p>
                </div>
              </div>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div class="bg-green-50 p-4 rounded-lg">
                    <div class="text-2xl font-bold text-green-600">
                      {settings()?.default_user_invite_limit}
                    </div>
            ...
            <div class="flex">
              ...
              <div class="ml-3">
                ...
                <div class="mt-2 text-sm text-yellow-700">
                  <p>
                    Changes to these settings affect the entire system. Be
                    careful when modifying user limits and registration settings
                    as they may impact existing users and new registrations.
                  </p>
                </div>
              </div>
            </div>
